...
// represents a fake database made for testing purposes
// can also be done with mock or we create our own fake as in here
class FakeNoteCacheDataSourceImpl
constructor(
    private val notesData: HashMap<String, Note>, // the holder of our notes
    private val dateUtil: DateUtil
) : NoteCacheDataSource {

    // represents the insertion of notes with fail cases attached
    ...
    // represents the deletion of notes with fail cases attached
    ...
    override suspend fun searchNotes(
        ...
        for (note in notesData.values) {
            ...
            // to avoid getting out of boundaries
