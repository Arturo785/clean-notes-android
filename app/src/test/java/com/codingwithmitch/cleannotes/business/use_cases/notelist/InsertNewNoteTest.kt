...
import com.codingwithmitch.cleannotes.business.use_cases.notelist.InsertNewNote.Companion.INSERT_NOTE_SUCCESS
...
class InsertNewNoteTest {
    ...
    // better to use the before annotation instead of the init
    init {
        dependencyContainer = DependencyContainer()
        dependencyContainer.build()
        // references the created ones in the di container mock
        noteCacheDataSource = dependencyContainer.noteCacheDataSource
        noteNetworkDataSource = dependencyContainer.noteNetworkDataSource
        noteFactory = dependencyContainer.noteFactory

        // creates the usa case
    ...
    fun insertNote_success_confirmNetworkAndCacheUpdated() = runBlocking {
        ...
        insertNewNote.insertNewNote(
            ...
            // this way we can collect the emissions of the flow
