...
constructor(
    private val notesData: HashMap<String, Note>, // our holder to mock the notes
    private val deletedNotesData: HashMap<String, Note> // the holder of our deleted notes to simulate the firebase instance
