package com.codingwithmitch.cleannotes.business.use_cases.notelist
...
import com.codingwithmitch.cleannotes.business.use_cases.notelist.DeleteMultipleNotes.Companion.DELETE_NOTES_ERRORS
import com.codingwithmitch.cleannotes.business.use_cases.notelist.DeleteMultipleNotes.Companion.DELETE_NOTES_SUCCESS
...
class DeleteMultipleNotesTest {
    ...
    // the same as @After but for Junit 5
    @AfterEach
    fun afterEach() {
        deleteMultipleNotes = null
    }

    // the same as @Before but for Junit 5
    @BeforeEach
    fun beforeEach() {
    ...
    fun deleteNotes_success_confirmNetworkAndCacheUpdated() = runBlocking {
        ...
        for (note in notesInCache) {
            randomNotes.add(note) // the ones to be deleted
