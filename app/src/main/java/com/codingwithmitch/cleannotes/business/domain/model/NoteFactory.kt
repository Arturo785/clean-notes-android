...
// Used to create notes and make usage of the data class
// this factory may should be in the framework package because of the dagger annotations and firestore
@Singleton
class NoteFactory
@Inject
constructor(
