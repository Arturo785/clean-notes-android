...
// this class is the one that receives the dataStates, holds them and manages them
@FlowPreview
...
abstract class DataChannelManager<ViewState> {
    ...
    // reacts to the different scenarios of the received events
            ...
            .onEach { dataState ->
                withContext(Main) {
                    ...
                    dataState.stateMessage?.let { stateMessage ->
                        // attaches the new message to the stack of messages
